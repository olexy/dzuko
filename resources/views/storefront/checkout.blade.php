                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <button type="submit" class="btn mt_20" data-loading-text="Loading..." id="button-login">Login</button>
                    </form>
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <input name="amount" type="hidden" id="amount"  value="{{ Cart::total() }}"/>
                            </tr>
                            </tfoot>
                        </table>
                        </div>
                        <div class="buttons">
                        <div class="pull-right">
                            <button type="submit" data-loading-text="Loading..." class="btn" id="button-confirm">Confirm Order</button>
                        </div>
                        </div>
                    </div>
                </form>
